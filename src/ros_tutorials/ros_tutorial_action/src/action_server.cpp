...
#include <ros_tutorial_action/FibonacciAction.h> // FibonacciAction Action File Header
...
protected:
  ...
  actionlib::SimpleActionServer<ros_tutorial_action::FibonacciAction> as_; // Action server declaration, NodeHandle instance must be created before this line. Otherwise strange error occurs.
