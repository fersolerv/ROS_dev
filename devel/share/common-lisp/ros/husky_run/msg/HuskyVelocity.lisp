...
(cl:defmethod cl:initialize-instance :after ((m <HuskyVelocity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HuskyVelocity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name husky_run-msg:<HuskyVelocity> is deprecated: use husky_run-msg:HuskyVelocity instead.")))

(cl:ensure-generic-function 'linearVelocityX-val :lambda-list '(m))
(cl:defmethod linearVelocityX-val ((m <HuskyVelocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader husky_run-msg:linearVelocityX-val is deprecated.  Use husky_run-msg:linearVelocityX instead.")
  (linearVelocityX m))

(cl:ensure-generic-function 'angularVelocityZ-val :lambda-list '(m))
(cl:defmethod angularVelocityZ-val ((m <HuskyVelocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader husky_run-msg:angularVelocityZ-val is deprecated.  Use husky_run-msg:angularVelocityZ instead.")
  (angularVelocityZ m))
