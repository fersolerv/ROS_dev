...
(cl:in-package ros_tutorial_service-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SrvTutorial-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvTutorial-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_tutorial_service-srv:<SrvTutorial-request> is deprecated: use ros_tutorial_service-srv:SrvTutorial-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <SrvTutorial-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_tutorial_service-srv:a-val is deprecated.  Use ros_tutorial_service-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <SrvTutorial-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_tutorial_service-srv:b-val is deprecated.  Use ros_tutorial_service-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvTutorial-request>)))
  ...
  "ros_tutorial_service/SrvTutorialRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvTutorial-request)))
  "Returns string type for a service object of type 'SrvTutorial-request"
  "ros_tutorial_service/SrvTutorialRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SrvTutorial-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvTutorial-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_tutorial_service-srv:<SrvTutorial-response> is deprecated: use ros_tutorial_service-srv:SrvTutorial-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <SrvTutorial-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_tutorial_service-srv:result-val is deprecated.  Use ros_tutorial_service-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvTutorial-response>)))
  ...
  "ros_tutorial_service/SrvTutorialResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvTutorial-response)))
  "Returns string type for a service object of type 'SrvTutorial-response"
  "ros_tutorial_service/SrvTutorialResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvTutorial)))
  ...
  "ros_tutorial_service/SrvTutorial")