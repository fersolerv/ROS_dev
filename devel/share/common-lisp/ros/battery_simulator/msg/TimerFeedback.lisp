...
(cl:defmethod cl:initialize-instance :after ((m <TimerFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name battery_simulator-msg:<TimerFeedback> is deprecated: use battery_simulator-msg:TimerFeedback instead.")))

(cl:ensure-generic-function 'time_elapsed-val :lambda-list '(m))
(cl:defmethod time_elapsed-val ((m <TimerFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader battery_simulator-msg:time_elapsed-val is deprecated.  Use battery_simulator-msg:time_elapsed instead.")
  (time_elapsed m))

(cl:ensure-generic-function 'time_remaining-val :lambda-list '(m))
(cl:defmethod time_remaining-val ((m <TimerFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader battery_simulator-msg:time_remaining-val is deprecated.  Use battery_simulator-msg:time_remaining instead.")
  (time_remaining m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TimerFeedback>)))
  ...
  "battery_simulator/TimerFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TimerFeedback)))
  "Returns string type for a message object of type 'TimerFeedback"
  "battery_simulator/TimerFeedback")
