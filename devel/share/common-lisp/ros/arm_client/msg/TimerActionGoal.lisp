...
(cl:defclass <TimerActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type arm_client-msg:TimerGoal
    :initform (cl:make-instance 'arm_client-msg:TimerGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TimerActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_client-msg:<TimerActionGoal> is deprecated: use arm_client-msg:TimerActionGoal instead.")))
