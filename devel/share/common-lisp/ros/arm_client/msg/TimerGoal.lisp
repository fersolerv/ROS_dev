...
(cl:defmethod cl:initialize-instance :after ((m <TimerGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_client-msg:<TimerGoal> is deprecated: use arm_client-msg:TimerGoal instead.")))

(cl:ensure-generic-function 'time_to_wait-val :lambda-list '(m))
(cl:defmethod time_to_wait-val ((m <TimerGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_client-msg:time_to_wait-val is deprecated.  Use arm_client-msg:time_to_wait instead.")
  (time_to_wait m))
