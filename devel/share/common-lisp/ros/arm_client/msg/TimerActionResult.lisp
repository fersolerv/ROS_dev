...
(cl:defclass <TimerActionResult> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (result
    :reader result
    :initarg :result
    :type arm_client-msg:TimerResult
    :initform (cl:make-instance 'arm_client-msg:TimerResult)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TimerActionResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimerActionResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_client-msg:<TimerActionResult> is deprecated: use arm_client-msg:TimerActionResult instead.")))
