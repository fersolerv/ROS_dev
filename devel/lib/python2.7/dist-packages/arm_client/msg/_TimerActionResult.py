...
"""autogenerated by genpy from arm_client/TimerActionResult.msg. Do not edit."""
import sys
...
class TimerActionResult(genpy.Message):
  ...
  _type = "arm_client/TimerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','arm_client/TimerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = arm_client.msg.TimerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = arm_client.msg.TimerResult()
